...
export default {
  ...
  methods: {
    ...
    async createColumn(column) {
      await axios.post(this.$store.state.backendLink + "/saveTableColumn", column, {
        headers: {
    ...
    async updateColumn(column) {
      await axios.post(this.$store.state.backendLink + "/updateTableColumn", column, {
        headers: {
          'Content-Type': 'application/json',
          'Authorization': localStorage.getItem('token')
        }
    ...
    async deleteColumn(column) {
      await axios.post(this.$store.state.backendLink + "/deleteTableColumn", column, {
        headers: {
          'Content-Type': 'application/json',
          'Authorization': localStorage.getItem('token')
        }
    ...
    getAllColumns() {
      axios.get(this.$store.state.backendLink + "/getAllTableColumns", {
        headers: {
          'Authorization': localStorage.getItem('token'),
    ...
    async createTask(data, column) {
      ...
      await axios.post(this.$store.state.backendLink + "/saveTableTask", data, {
        headers: {
          'Content-Type': 'application/json',
          'Authorization': localStorage.getItem('token')
        }
    ...
    async updateTask(data) {
      await axios.post(this.$store.state.backendLink + "/updateTableTask", data, {
        headers: {
          'Content-Type': 'application/json',
          'Authorization': localStorage.getItem('token')
        }
    ...
    async deleteTask(data) {
      await axios.post(this.$store.state.backendLink + "/deleteTableTask", data, {
        headers: {
          'Content-Type': 'application/json',
          'Authorization': localStorage.getItem('token')
        }
    ...
    getAllTasks(column, index) {
      axios.post(this.$store.state.backendLink + "/getAllTableTasks", column, {
        headers: {
          'Authorization': localStorage.getItem('token'),
          'Content-Type': 'application/json'
        }
