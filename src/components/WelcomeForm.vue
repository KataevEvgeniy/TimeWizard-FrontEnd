<template>
  <div class="container">
    ...
    <div class="form">
      ...
      <button class="white_button" :style="{backgroundColor:typeMenu === 'Register'?'#333':'#fff'}"
              @click="typeMenu='Register'">Register
      </button>
...
<script>
import login_form from "./welcomeForm/LoginForm.vue"
import register_form from "./welcomeForm/RegisterForm.vue"
